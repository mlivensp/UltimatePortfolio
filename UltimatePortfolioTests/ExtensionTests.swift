...
final class ExtensionTests: BaseTestCase {
    ...
    func testIssueSortingIsStable() {
        ...
        XCTAssertEqual(sorted, [issue3, issue1, issue2], "Sorting issue arrays should use name then creation date.")
    }
    ...
    func testTagActiveIssues() {
        ...
        XCTAssertEqual(tag.tagActiveIssues.count, 0, "A new tag with 1 complete issue should have 0 active issues.")
    }
